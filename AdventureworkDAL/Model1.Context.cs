...
namespace AdventureworkDAL
{
    ...
    public partial class AdventureWorks2012Entities : DbContext
    {
        ...
        public virtual ObjectResult<uspProductsList_Result> uspProductsList(Nullable<decimal> min_listPrice, Nullable<decimal> max_listPrice)
        {
            var min_listPriceParameter = min_listPrice.HasValue ?
                new ObjectParameter("min_listPrice", min_listPrice) :
                new ObjectParameter("min_listPrice", typeof(decimal));
    
            var max_listPriceParameter = max_listPrice.HasValue ?
                new ObjectParameter("max_listPrice", max_listPrice) :
                new ObjectParameter("max_listPrice", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspProductsList_Result>("uspProductsList", min_listPriceParameter, max_listPriceParameter);
        }
